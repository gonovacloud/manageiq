class SetCorrectStiTypeAndEmsIdOnAzureCloudSubnet < ActiveRecord::Migration[5.0]
  ...
  def up
    ...
    ExtManagementSystem
      .where(:type => 'NOVAHawk::Providers::Azure::NetworkManager').each do |ems|
      CloudSubnet
        ...
        .update_all("type = 'NOVAHawk::Providers::Azure::NetworkManager::CloudSubnet', ems_id = '#{ems.id}'")
    end
  end
  ...
  def down
    ...
    CloudSubnet
      ...
      .where(:cloud_subnets => {:type => 'NOVAHawk::Providers::Azure::NetworkManager::CloudSubnet'},
             :cloud_manager => {:type => 'NOVAHawk::Providers::Azure::CloudManager'})
