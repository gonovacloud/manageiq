describe('NOVAHawk.charts.formatters', function() {
  describe('curried/uncurried', function() {
    ...
    it('foo(val, opt)', function() {
      var fn = NOVAHawk.charts.formatters[options.name];
      expect(fn(1234, options)).toEqual('1,234');
    });

    it('foo.c3(opt)(val)', function() {
      var fn = NOVAHawk.charts.formatters[options.name].c3(options);
      expect(fn(1234)).toEqual('1,234');
    });

    it('foo.jqplot(opt)(_, val)', function() {
      var fn = NOVAHawk.charts.formatters[options.name].jqplot(options);
