describe ConfigurationJobController do
  ...
  context "#tags_edit" do
    ...
    before(:each) do
      ...
      session[:tag_db] = "NOVAHawk::Providers::AnsibleTower::ConfigurationManager::Job"
      edit = {
        :key        => "NOVAHawk::Providers::AnsibleTower::ConfigurationManager::Job_edit_tags__#{@cj.id}",
        :tagging    => "NOVAHawk::Providers::AnsibleTower::ConfigurationManager::Job",
        :object_ids => [@cj.id],
        :current    => {:assignments => []},
