...
describe RemoveSystemAddSourceToMiqAeNamespace do
  ...
  migration_context :up do
    it "migrates system to source" do
      miq_ae_namespace_stub.create!(:name => 'NOVAHawk', :system => true, :parent_id => nil)
      ...
      expect(miq_ae_namespace_stub.find_by_name('NOVAHawk').source).to eql("system")
  ...
  migration_context :down do
    it "migrates source to system" do
      miq_ae_namespace_stub.create!(:name => 'NOVAHawk', :source => "system", :parent_id => nil)
      ...
      expect(miq_ae_namespace_stub.count).to eq 3
      expect(miq_ae_namespace_stub.find_by_name('NOVAHawk').system).to be_truthy
