FactoryGirl.define do
  ...
  factory :orchestration_stack_cloud, :parent => :orchestration_stack, :class => "NOVAHawk::Providers::CloudManager::OrchestrationStack" do
  end

  factory :orchestration_stack_cloud_with_template, :parent => :orchestration_stack, :class => "NOVAHawk::Providers::CloudManager::OrchestrationStack" do
    orchestration_template { FactoryGirl.create(:orchestration_template) }
  end

  factory :orchestration_stack_amazon, :parent => :orchestration_stack, :class => "NOVAHawk::Providers::Amazon::CloudManager::OrchestrationStack" do
  end

  factory :orchestration_stack_amazon_with_non_orderable_template, :parent => :orchestration_stack, :class => "NOVAHawk::Providers::Amazon::CloudManager::OrchestrationStack" do
    orchestration_template { FactoryGirl.create(:orchestration_template_cfn, :orderable => false) }
  end

  factory :orchestration_stack_azure, :parent => :orchestration_stack, :class => "NOVAHawk::Providers::Azure::CloudManager::OrchestrationStack" do
  end

  factory :orchestration_stack_openstack, :parent => :orchestration_stack, :class => "NOVAHawk::Providers::Openstack::CloudManager::OrchestrationStack" do
  end

  factory :orchestration_stack_openstack_infra,
          :parent => :orchestration_stack,
          :class  => "NOVAHawk::Providers::Openstack::InfraManager::OrchestrationStack" do
    after :create do |x|
  ...
  factory :ansible_tower_job, :class => "NOVAHawk::Providers::AnsibleTower::ConfigurationManager::Job" do
  end

  factory :orchestration_stack_vmware_cloud, :parent => :orchestration_stack, :class => "NOVAHawk::Providers::Vmware::CloudManager::OrchestrationStack" do
  end
end
