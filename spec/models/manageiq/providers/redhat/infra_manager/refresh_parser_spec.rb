describe NOVAHawk::Providers::Redhat::InfraManager::RefreshParser do
  context "#vm_inv_to_disk_hashes" do
    it "should assign location by boot order and name" do
      ...
      result = NOVAHawk::Providers::Redhat::InfraManager::RefreshParser.vm_inv_to_disk_hashes(disk_inv, {})
  ...
  context "#vm_inv_to_custom_attribute_hashes" do
    it "should truncate the custom attribute value" do
      ...
      result = NOVAHawk::Providers::Redhat::InfraManager::RefreshParser.vm_inv_to_custom_attribute_hashes(inv)
      expect(result).to eq([
        {
  ...
  context "#extract_host_os_name" do
    it "should extract the host OS name from os element" do
      ...
      result = NOVAHawk::Providers::Redhat::InfraManager::RefreshParser.extract_host_os_name(host_inv)
    ...
    it "should call #extract_host_os_name as part of host OS parsing" do
      ...
      expect(NOVAHawk::Providers::Redhat::InfraManager::RefreshParser).to receive(:extract_host_os_name)
      NOVAHawk::Providers::Redhat::InfraManager::RefreshParser.host_inv_to_os_hash(host_inv, "")
    end
  end
end
