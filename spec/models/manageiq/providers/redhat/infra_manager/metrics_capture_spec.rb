describe NOVAHawk::Providers::Redhat::InfraManager::MetricsCapture do
  ...
  context '#perf_collect_metrics' do
    ...
    it 'collects historical metric data according to the value of historical_start_time' do
      ...
      allow_any_instance_of(NOVAHawk::Providers::Redhat::InfraManager).to receive(:history_database_name)
                                                                      .and_return('stuff')
