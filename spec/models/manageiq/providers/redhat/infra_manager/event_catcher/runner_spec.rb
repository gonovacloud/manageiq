describe NOVAHawk::Providers::Redhat::InfraManager::EventCatcher::Runner do
  context "#event_monitor_options" do
    ...
    before do
      allow_any_instance_of(NOVAHawk::Providers::Redhat::InfraManager).to receive_messages(:authentication_check => [true, ""])
