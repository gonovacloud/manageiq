class NOVAHawk::Providers::Azure::CloudManager::OrchestrationStack < NOVAHawk::Providers::CloudManager::OrchestrationStack
  require_dependency 'novahawk/providers/azure/cloud_manager/orchestration_stack/status'
  include_concern 'NOVAHawk::Providers::Azure::CloudManager::Deployment'
