class NOVAHawk::Providers::Foreman::ConfigurationManager::ConfigurationProfile < ::ConfigurationProfile
  belongs_to :parent, :class_name => 'NOVAHawk::Providers::Foreman::ConfigurationManager::ConfigurationProfile'
  ...
  has_many :children,
           :class_name  => 'NOVAHawk::Providers::Foreman::ConfigurationManager::ConfigurationProfile',
