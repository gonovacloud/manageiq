module NOVAHawk::Providers::Foreman::ConfigurationManager::ConfiguredSystem::Placement
  def available_configuration_profiles
    ...
    cp_no_cl = ConfigurationProfile.includes(:configuration_locations).where("configuration_locations_configuration_profiles.configuration_profile_id" => nil)
    cp_no_co = ConfigurationProfile.includes(:configuration_organizations).where("configuration_organizations_configuration_profiles.configuration_profile_id" => nil)
