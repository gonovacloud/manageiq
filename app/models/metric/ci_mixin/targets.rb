module Metric::CiMixin::Targets
  def perf_capture_always?
    ...
    when NOVAHawk::Providers::Openstack::InfraManager::Host, NOVAHawk::Providers::Openstack::InfraManager::EmsCluster then true
    when NOVAHawk::Providers::Kubernetes::ContainerManager::Container then true
    when NOVAHawk::Providers::Kubernetes::ContainerManager::ContainerGroup then true
    when NOVAHawk::Providers::Kubernetes::ContainerManager::ContainerNode then true
