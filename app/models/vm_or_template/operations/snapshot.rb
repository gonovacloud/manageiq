module VmOrTemplate::Operations::Snapshot
  ...
  def remove_snapshot_by_description(description, refresh = false, retry_time = nil)
    if (ext_management_system.kind_of?(NOVAHawk::Providers::Vmware::InfraManager) && NOVAHawk::Providers::Vmware::InfraManager.use_vim_broker? && MiqVimBrokerWorker.available?) || host.nil? || host.state == "on"
