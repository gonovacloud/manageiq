class TreeBuilder
  ...
  X_TREE_NODE_PREFIXES = {
    ...
    "at"  => "NOVAHawk::Providers::AnsibleTower::ConfigurationManager",
    "cl"  => "Classification",
    ...
    "c"   => "EmsCluster",
    "csf" => "NOVAHawk::Providers::Foreman::ConfigurationManager::ConfiguredSystem",
    "csa" => "NOVAHawk::Providers::AnsibleTower::ConfigurationManager::ConfiguredSystem",
    "f"   => "EmsFolder",
    "fr"  => "NOVAHawk::Providers::Foreman::ConfigurationManager",
    "g"   => "MiqGroup",
    "gd"  => "GuestDevice",
    "h"   => "Host",
    ...
    "u"   => "User",
    "v"   => "Vm",
    "vap" => "NOVAHawk::Providers::Vmware::CloudManager::OrchestrationTemplate",
